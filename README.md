![delordle](https://raw.githubusercontent.com/MikhaD/delordle/main/public/img/og_1200x630.png)
<div align="center">
  <a href="https://mikhad.github.io/delordle/" ><img src="https://github.com/MikhaD/delordle/workflows/Publish/badge.svg?branch=main" alt="Publish workflow"/></a>
  <img src="https://img.shields.io/github/package-json/v/MikhaD/delordle" alt="GitHub package.json version" />
</div>

---
A recreation of the popular game [delordle](https://www.powerlanguage.co.uk/delordle/) by Josh Wardle, with additional modes and features.
Hosted on GitHub pages [here](https://mikhad.github.io/delordle/).
...
This is still in development. My goal is to make it as close to the original delordle as possible while also adding additional features. I will continue to make it more similar to the original.
...
- add a refresh button next to the tutorial button when a new delordle is available for a given mode
